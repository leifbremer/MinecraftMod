...
public class ModArmorMaterial implements ArmorMaterial {
    ...
    public ModArmorMaterial(int[] durabilityForType, int[] defenseForType, int enchantability, SoundEvent equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairMaterial, String name) {
